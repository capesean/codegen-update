    ...
    public class Code
    {
        ...
        public string GenerateModalHtml()
        {
            ...
            if (CurrentEntity.Fields.Any(o => o.SearchType == SearchType.Text))
            {
                ...
                appTextFilter += $"                            <input type=\"search\" ngbAutofocus autocomplete=\"off\" name=\"q\" id=\"q\" [(ngModel)]=\"searchOptions.q\" max=\"100\" class=\"form-control\" placeholder=\"Search PLURALFRIENDLYNAME_TOLOWER\" />" + Environment.NewLine;
